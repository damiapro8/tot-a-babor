...
function create() {
    ...
    textDebugar = this.add.text(0, 0, 'Debug Info', {
        fontSize: '40px',
        fill: '#ffffff',
        fontFamily: 'Arial',
    ...
    // UI lootbox
    ActivarOpcions = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.O);
    fonsOpcio1 = this.add.rectangle(PosXLoot, PosYLoot, ampladaLoot, alçadaLoot, 0x444444);
    fonsOpcio1.setOrigin(0, 0);
    fonsOpcio1.setScrollFactor(0);
    fonsOpcio1.setVisible(false);
    fonsOpcio1.setDepth(1000);
    fonsOpcio1.setAlpha(0.6);

    fonsOpcio2 = this.add.rectangle(PosXLoot + ampladaLoot + paddingLoot, PosYLoot, ampladaLoot, alçadaLoot, 0x444444);
    fonsOpcio2.setOrigin(0, 0);
    fonsOpcio2.setScrollFactor(0);
    fonsOpcio2.setVisible(false);
    fonsOpcio2.setDepth(1000);
    fonsOpcio2.setAlpha(0.6);

    fonsOpcio3 = this.add.rectangle(PosXLoot + 2*ampladaLoot + 2*paddingLoot, PosYLoot, ampladaLoot, alçadaLoot, 0x444444);
    fonsOpcio3.setOrigin(0, 0);
    fonsOpcio3.setScrollFactor(0);
    fonsOpcio3.setVisible(false);
    fonsOpcio3.setDepth(1000);
    fonsOpcio3.setAlpha(0.6);
...
function update(time, delta) {
    ...
    if (Phaser.Input.Keyboard.JustDown(ActivarOpcions)) {
        let visible = fonsOpcio1.visible;
        fonsOpcio1.setVisible(!visible);
        fonsOpcio2.setVisible(!visible);
        fonsOpcio3.setVisible(!visible);
    }
